    ...
    <table class="table table-bordered table-hover">
        <tr>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('shops.status',[$shop]) }}">
                        <button class="btn btn-primary"><span>审核</span></button>
                    </a>
                    <a href="{{ route('shops.disable',[$shop]) }}">
                        <button class="btn btn-danger"><span>禁用</span></button>
                    </a>
                </td>
            </tr>
        <tr>
